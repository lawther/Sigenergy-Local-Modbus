...
DC_CHARGER_PARAMETER_REGISTERS = {
    # Moved from INVERTER_PARAMETER_REGISTERS because it is only applicable to DC Charger
    ...
    # Moved from DC_CHARGER_RUNNING_INFO_REGISTERS because it is only applicable to DC Charger
